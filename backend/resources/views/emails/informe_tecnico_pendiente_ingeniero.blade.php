...
<head>
    <meta charset="utf-8">
    <title>Solicitud pendiente para informe técnico - Proseguir</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>El Director de Crédito aprobó la documentación inicial de la siguiente solicitud de crédito Constructor. Queda pendiente para el diligenciamiento del Informe Técnico.</p>
            ...
            <p style="text-align:center;">
                <a href="{{ $urlAcceso }}" class="btn">GESTIONAR INFORME TÉCNICO</a>
            </p>
        </div>
        <div class="footer">
