...
<head>
    <meta charset="utf-8">
    <title>Transferencia bancaria realizada - Proseguir</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Estimado(a) {{ $transferencia['titular_cuenta'] ?? 'cliente' }}:</p>
            <p>Le confirmamos que Tesorería realizó la transferencia bancaria correspondiente al desembolso de su solicitud de crédito No. <strong>{{ $credito->numero_solicitud }}</strong>.</p>
