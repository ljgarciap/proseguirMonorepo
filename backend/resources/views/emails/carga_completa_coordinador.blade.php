...
<head>
    <meta charset="utf-8">
    <title>Cliente completó el cargue de documentos - Proseguir</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>El cliente <strong>{{ $solicitud->cliente->nombre }}</strong> ha completado el cargue de todos los documentos solicitados para su solicitud de crédito. Por favor, ingrese al sistema para realizar la validación correspondiente.</p>
            ...
            <div class="highlight-box">
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ $solicitud->cliente->identificacion ?? $solicitud->cliente->numero_documento }}</td>
                    </tr>
                    <tr>
            ...
            <p style="text-align:center;">
                <a href="{{ $urlValidacion }}" class="btn">VALIDAR DOCUMENTACIÓN</a>
            </p>
        </div>
        <div class="footer">
