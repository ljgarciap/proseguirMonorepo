...
<head>
    <meta charset="utf-8">
    <title>Nuevo documento pendiente de revisión - Proseguir</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Estimado(a):</p>
            <p>Hay un documento nuevo pendiente de revisión en la Bandeja Interna de Documentos.</p>
            <div class="highlight-box">DOCUMENTO PENDIENTE DE REVISIÓN</div>
