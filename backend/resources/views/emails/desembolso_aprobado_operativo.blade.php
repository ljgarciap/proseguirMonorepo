...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Estimado(a):</p>
            <p>Gerencia aprobó la Operación de Desembolso en CYF de la solicitud No. <strong>{{ $credito->numero_solicitud }}</strong> (radicado {{ $credito->radicado_cyf }}).</p>
            <div class="highlight-box">DESEMBOLSO APROBADO</div>
            <p>Este correo es informativo: la solicitud continúa bajo gestión de Tesorería, que efectuará y registrará la transferencia bancaria. No requiere ninguna acción de su parte.</p>
            <p style="text-align:center;">
                <a href="{{ $urlIngreso }}" class="btn">Consultar la solicitud</a>
            </p>
