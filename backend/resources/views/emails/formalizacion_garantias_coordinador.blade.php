...
<head>
    <meta charset="utf-8">
    <title>Garantías validadas exitosamente - Proseguir</title>
    <style>
        ...
        .header { background-color: #1e3a8a; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 30px; text-align: center; color: #ffffff; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>El proceso de validación de garantías de la solicitud de crédito No. <strong>{{ $credito->numero_solicitud }}</strong>, correspondiente a {{ $nombreCliente }}, finalizó exitosamente. Todos los documentos y garantías requeridos fueron aprobados.</p>
            <div class="highlight-box">GARANTÍAS VALIDADAS EXITOSAMENTE</div>
            <p>La solicitud se encuentra lista para continuar con la siguiente actividad. Puede proceder con el Registro de Crédito en CYF desde la funcionalidad Gestión de Créditos.</p>
            <p style="text-align:center;">
                <a href="{{ $urlAcceso }}" class="btn">REGISTRAR CRÉDITO EN CYF</a>
            </p>
