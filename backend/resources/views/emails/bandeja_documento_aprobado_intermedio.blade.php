...
<head>
    <meta charset="utf-8">
    <title>Documento aprobado - Continúa en proceso - Proseguir</title>
    <style>
        ...
        .header { background-color: #78350f; background: linear-gradient(135deg, #78350f 0%, #d97706 100%); padding: 30px; text-align: center; color: #ffffff; }
        .header h1 { margin: 0; font-size: 24px; font-weight: 700; }
        .content { padding: 30px; line-height: 1.6; }
        .content p { margin: 0 0 15px 0; font-size: 16px; color: #4a5568; }
        .highlight-box { padding: 16px 20px; margin: 20px 0; border-radius: 8px; font-weight: 700; text-align: center; background-color: #fffbeb; border-left: 4px solid #d97706; color: #92400e; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Estimado(a):</p>
            <p>Un paso de la ruta de aprobación del documento fue aprobado y el proceso continúa.</p>
            <div class="highlight-box">APROBADO — EN PROCESO</div>
